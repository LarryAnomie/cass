...
Highcharts.theme={colors:["#f7f7f7","#b02a1a"],labels:{style:{color:"#333333",font:"12px Arial"}},legend:{layout:"vertical",backgroundColor:"#FFF",borderRadius:0,borderColor:"#cccccc",symbolPadding:10,align:"left",verticalAlign:"top",floating:true,shadow:true,itemStyle:{cursor:"pointer",font:"12px Arial",color:"#333333"}},plotOptions:{pie:{borderColor:"#cccccc",cursor:"pointer",dataLabels:{enabled:true,color:"#333",connectorColor:"#ccc",style:{color:"#333333",font:"12px Arial"}},shadow:false},series:{stacking:"normal"},bar:{borderColor:"#cccccc",shadow:false}},subtitle:{style:{color:"#333333",font:'12px Georgia, "Times New Roman", Times, serif'}},title:{style:{color:"#333333",font:'24px Georgia, "Times New Roman", Times, serif'}},tooltip:{style:{color:"#333333",font:"12px Arial"}},xAxis:{labels:{style:{color:"#ba433d",font:"14px Arial"}},lineColor:"#cccccc",gridLineColor:"#f7f7f7"},yAxis:{labels:{style:{color:"#333333",font:"12px Arial"}},gridLineColor:"#f7f7f7",lineColor:"#e7e7e7",title:{style:{color:"#333333",font:"12px Arial"},margin:10}}};var highchartsOptions=Highcharts.setOptions(Highcharts.theme);